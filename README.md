...
The Trivia app is able to perform the following tasks:
...
The frontend app is hosted on http://127.0.0.1:3000/.

### Error Handling

Errors are formatted as JSON objects
...
```
The API is expected to return four error types when requests fail:
